...
<head>
	<meta charset="UTF-8">
	<title>Confirm Delete Phone</title>
</head>
<body>
	<%@include file="/admin/admin-menu.jsp"%>
	<h1>Confirm Delete Phone</h1>
	<form action="<c:url value='/admin/confirm-delete-phone' />" method="POST">
		...
		<table>
			...
			<tr>
				<td><input type="submit" value="Confirm Delete Phone"></td>
			</tr>
		</table>
	</form>
</body>
